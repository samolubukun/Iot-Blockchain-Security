...
# ============================================================================
st.set_page_config(
    page_title="IoT Blockchain Security Anomaly Detection System",
    page_icon="🔐",
    layout="wide",
...
def main():
    ...
    st.markdown("""
        <h1 style='text-align: center; margin-bottom: 0;'>
            🔐 IoT Blockchain Security Anomaly Detection System
        </h1>
        ...
        with col1:
            ...
            st.markdown("""
                **Core Features:**
                ...
                - ⚡ Simulated Real-time prediction capabilities
    ...
    # ========================================================================
        ...
        with tab1:
            ...
            The **IoT Blockchain Security Anomaly Detection System** is an machine learning platform designed 
            to provide simulated real-time security monitoring and anomaly detection for IoT networks integrated with blockchain technology.
            
            ### Key Features
            
            #### 🔍 **Threat Detection**
            - Simulated Real-time analysis of IoT network traffic
            - Multi-layer security monitoring (Device, Network, Application)
            - Support for 5 major threat categories
            - Confidence scoring for each prediction
            
            #### 🤖 **Machine Learning**
            - Trained on Simulated real-world IoT transactions
        ...
        with tab3:
            ...
            The system uses **Isolation Forest**, a machine learning-based anomaly detection algorithm that:
